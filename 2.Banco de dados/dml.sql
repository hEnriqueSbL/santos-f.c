...
-- CASO DE USO 01:: efetuar login 1
...
-- CASO DE USO 05:: consultar todos os filmes      
SELECT id_filme			id,
	  nm_filme			nome,
...
-- CASO DE USO 06:: consultar filmes por nome
SELECT id_filme			id,
	  nm_filme			nome,
       vl_avaliacao		avaliacao,
       dt_lancamento	lancamento,
...
-- CASO DE USO 07:: consultar filme por id
SELECT id_filme		id,
	  nm_filme	     nome,
       vl_avaliacao		avaliacao,
	  ds_sinopse		sinopse,
